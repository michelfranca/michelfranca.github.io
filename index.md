...
Este site foi construído com **Jekyll** e o tema **"Just the Docs"**, hospedado gratuitamente no **GitHub Pages**. Ele serve como meu portfólio vivo e um recurso para a comunidade. Cada marcação de progresso e cada novo conteúdo é um `commit` no meu perfil do GitHub, documentando publicamente minha jornada de desenvolvimento contínuo.
