...
Marque os itens abaixo conforme for concluindo os estudos. Cada seção de nível termina com um espaço para você anexar seus projetos e exercícios práticos.
...
### 🎓 Exercícios e Anexos - Nível Júnior
*Esta seção é o seu portfólio! Adicione aqui os links para seus projetos, exercícios resolvidos e qualquer material que comprove seu aprendizado.*

- **Projeto Prático - Análise de Vendas de uma Livraria:**
  - **Status:** [ ] Não iniciado / [ ] Em andamento / [ ] Concluído
  - **Descrição:** Análise de um conjunto de tabelas (Livros, Autores, Vendas) para responder perguntas de negócio.
  - **Anexos:**
    - [Link para o código SQL do projeto](link_para_seu_arquivo.sql)
    - [Link para a análise em PDF](assets/seu_pdf.pdf)
    - **Dashboard Final:**
      ![Descrição da sua imagem](assets/sua_imagem.png)
...
- [ ] **CTE (Common Table Expressions):** A cláusula `WITH` para legibilidade e modularidade.
...
### 🎓 Exercícios e Anexos - Nível Pleno
- **Projeto Prático - Análise de Churn de uma Plataforma de Streaming:**
  - **Status:** [ ] Não iniciado / [ ] Em andamento / [ ] Concluído
  - **Descrição:** Usando Joins, CTEs e funções de data, identificar padrões em clientes que cancelaram a assinatura.
  - **Anexos:**
    - [Link para o Estudo de Caso](link_para_pagina_do_projeto.md)
...
### 🎓 Exercícios e Anexos - Nível Sênior
- **Projeto Prático - Otimização de Dashboard de BI:**
  - **Status:** [ ] Não iniciado / [ ] Em andamento / [ ] Concluído
  - **Descrição:** Pegar queries lentas, analisar planos de execução, aplicar otimizações e medir o ganho de performance.
  - **Anexos:**
    - [Relatório de Performance (Antes e Depois)](assets/relatorio_otimizacao.pdf)
...
### 🎓 Exercícios e Anexos - Nível Especialista
- **Artigo Técnico - Comparativo de Performance: Redshift vs. BigQuery:**
  - **Status:** [ ] Não iniciado / [ ] Em andamento / [ ] Concluído
  - **Descrição:** Escrever um artigo técnico comparando a sintaxe e a performance de uma mesma query complexa em dois grandes data warehouses na nuvem.
  - **Anexos:**
    - [Link para o artigo publicado no Medium ou LinkedIn](link_para_seu_artigo.com)
